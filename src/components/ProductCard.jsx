...
function ProductCard({ id, name, price, compareAtPrice, img, stock, variants = [], hasVariants = false, fluid = false }) {
  ...
  return (
    <div className={fluid ? 'w-full' : 'w-[188px] shrink-0 snap-start sm:w-[190px] lg:w-[200px]'}>
      ...
      <div className="mt-3">
        ...
        <div className="mt-1 flex items-center justify-between">
          ...
          <button
            ...
            className="flex h-7 w-7 items-center justify-center rounded-lg bg-[#013485] text-white transition-all hover:scale-105"
          >
      ...
      {quickAddOpen && (
        <QuickAddModal
          product={{ id, name, price, compareAtPrice, img, stock, variants }}
